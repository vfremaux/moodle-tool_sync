...
$string['archivingdisabledbyconf'] = 'Fichier de commande non archivé (désactivé dans la configuration)';
...
$string['catidname'] = 'ID numérique ou chemin complet de noms (pour création)';
$string['catidnumbererror'] = 'Identification de catégorie {$a} non trouvée';
...
$string['cleanupdisabledbyconf'] = 'Fichier de commande non supprimé (désactivé dans la configuration)';
...
$string['cohortnotexists'] = 'Cohorte {$a->cohortid} inexistante pour l\'identifiant {$a->cid}. Abandon.';
...
$string['coursecategoryidentifier'] = 'Identifiant de catégorie';
$string['coursecheck'] = 'Vérification des cours';
$string['coursecreated'] = 'Le cours [{$a->shortname}] {$a->fullname} a été créé sous l\'id {$a->id}.';
...
$string['courseupdated'] = 'Cours [{$a->shortname}] {{$a->idnumber}} {$a->fullname} mis à jour sous l\'id {$a->id}.';
...
$string['enableenrolondisabled'] = 'Autoriser l\'inscription sur des plugins désactivés';
...
$string['errorprecheck'] = 'Erreur en phase de precheck';
...
$string['fileareacleanupdelay'] = 'Supprimer les fichiers stockés plus de (en jours)';
...
$string['nocompletiontoprocess'] = 'Pas de réinitialisation d\'achèvement à la ligne {$a}';
...
$string['nogradestoprocess'] = 'Pas de réinitialisation de notes à la ligne {$a}';
$string['nogrouptoprocess'] = 'Pas de réinitialisation de groupes à la ligne {$a}';
$string['nologstoprocess'] = 'Pas  de réinitialisation de logs à la ligne {$a}';
$string['nomatch'] = 'Aucun fichier disponible pour ce motif';
$string['nonotestoprocess'] = 'Pas de réinitialisation d\'annotations à la ligne {$a}';
...
$string['othermatchs'] = 'Autres fichiers potentiels';
...
$string['runnow'] = 'Charger et Exécuter';
$string['runagain'] = 'Relancer cet outil';
...
$string['synctemplateprocessingmode'] = 'Mode d\'intégration du template (pour les cours existants)';
$string['noprocess'] = '(Pas d\'intégration)';
$string['addcontent'] = 'Ajouter le contenu au cours';
$string['replacecontent'] = 'Remplacer le contenu du cours';
...
$string['task_fileareacleanup'] = 'Nettoyage de la zone de fichiers';
...
$string['trybackdisabledbyconf'] = 'Fichier de reprise non généré (désactivé dans la configuration)';
...
$string['usercreatecollision'] = 'Error : Collision d\'identifiant à la création de {$a}';
$string['usercreatedremotely'] = 'Utilisateur {$a->username} créé sur {$a->wwwroot} ';
$string['usercreatemailcollision'] = 'Error : Collision d\'adresse mail à la création de {$a}';
