...
class tool_sync_renderer extends plugin_renderer_base {
    ...
    public function print_reset_course_creator($syncconfig) {
        ...
        $str .= '<form name="form_reset" class="sync-reset-courses-form" method="post" action="#" onSubmit="return select_all(this)">';
        $str .= '<center>';
        ...
        $sortorder = @$syncconfig->courses_fileresetidentifier;
        ...
        foreach ($courses as $c) {
            ...
            if (@$prevc->shortname != $c->shortname) {
                ...
                $str .= "<td>$c->roleshortname : $c->people</td>";
            }
            $distinctcourses[$c->shortname] = $c;
            $prevc = $c;
        }
        ...
        foreach ($distinctcourses as $c) {
            $cid = tool_sync_get_course_identifier($c, 'courses_fileresetidentifier', $syncconfig);
