 ...
 */
class groupsync_task extends \core\task\scheduled_task {
    ...
    public function get_name() {
        return get_string('task_syncgroups', 'tool_sync');
    }
    ...
    public function execute() {
        ...
        $groupsmanager = new \tool_sync\group_sync_manager(SYNC_COURSE_GROUPS);
        $groupsmanager->cron($syncconfig);

        $groupsmanager = new \tool_sync\group_sync_manager(SYNC_GROUP_MEMBERS);
        $groupsmanager->cron($syncconfig);
