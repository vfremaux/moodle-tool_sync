...
define(['jquery', 'core/log', 'core/config'], function($, log, cfg) {
    ...
    var toolsyncpro = {
        ...
        component: 'tool_sync',
        shortcomponent: 'tool_sync',
        componentpath: 'admin/tool/sync',

        init: function() {

            var licensekeyid = '#id_s_' + toolsyncpro.component + '_licensekey';
            $(licensekeyid).bind('change', this.check_product_key);
            $(licensekeyid).trigger('change');
            log.debug('AMD Pro js initialized for ' + toolsyncpro.component + ' system');
        },
        ...
        check_product_key: function() {
            ...
            var calculated = toolsyncpro.checksum(payload);
            ...
            if (crc === calculated) {
                var url = cfg.wwwroot + '/' + toolsyncpro.componentpath + '/pro/ajax/services.php?';
                url += 'what=license';
                url += '&service=check';
                url += '&customerkey=' + that.val();
                url += '&provider=' + $('#id_s_' + toolsyncpro.component + '_licenseprovider').val();
